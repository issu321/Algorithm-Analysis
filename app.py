...
{c.END}
    ...
    def sorting_menu(self):
        ...
        print(f"\n{Colors.GREEN}[1]{Colors.END}  Bubble Sort            {Colors.GRAY}- O(n²) | Stable{Colors.END}")
        print(f"{Colors.GREEN}[2]{Colors.END}  Selection Sort         {Colors.GRAY}- O(n²) | Unstable{Colors.END}")
        print(f"{Colors.GREEN}[3]{Colors.END}  Insertion Sort         {Colors.GRAY}- O(n²) | Stable{Colors.END}")
        print(f"{Colors.GREEN}[4]{Colors.END}  Merge Sort             {Colors.GRAY}- O(n log n) | Stable{Colors.END}")
        print(f"{Colors.GREEN}[5]{Colors.END}  Quick Sort             {Colors.GRAY}- O(n log n) | Unstable{Colors.END}")
        print(f"{Colors.GREEN}[6]{Colors.END}  Heap Sort              {Colors.GRAY}- O(n log n) | Unstable{Colors.END}")
        print(f"{Colors.GREEN}[7]{Colors.END}  Shell Sort             {Colors.GRAY}- O(n log² n) | Unstable{Colors.END}")
        print(f"{Colors.GREEN}[8]{Colors.END}  Cocktail Shaker Sort   {Colors.GRAY}- O(n²) | Stable{Colors.END}")
        print(f"{Colors.GREEN}[9]{Colors.END}  Comb Sort              {Colors.GRAY}- O(n²/2^p) | Unstable{Colors.END}")
        print(f"{Colors.GREEN}[10]{Colors.END} Counting Sort          {Colors.GRAY}- O(n+k) | Stable{Colors.END}")
        print(f"{Colors.GREEN}[11]{Colors.END} Radix Sort             {Colors.GRAY}- O(d(n+k)) | Stable{Colors.END}")
        print(f"{Colors.GREEN}[12]{Colors.END} Compare All Sorts      {Colors.GRAY}- Benchmark suite{Colors.END}")
        print(f"{Colors.GREEN}[B]{Colors.END}  Back")
